...
def render_keyword_bar_chart(headlines_df: pd.DataFrame) -> None:
    ...
    stop_words = {
        ...
        "we're", "we've", "were", "what", "what's", "when", "when's", "where", "where's", "which", 
        "while", "who", "who's", "whom", "why", "why's", "with", "would", "you", "you'd", "you'll", 
        "you're", "you've", "your", "yours", "yourself", "yourselves", "will", "can", "just", "now", 
        "new", "says", "said", "one", "two", "also", "may", "apple", "exxon", "chevron", "shell", 
        "stock", "stocks", "market", "shares", "investors", "earnings", "aapl", "xom", "cvx", "shel",
        "inc", "corp", "company"
    }
